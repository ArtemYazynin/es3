...
import { Area, AreaService, AreaType, CommonService, CurrentEducationPlace, CurrentEducationPlaceStepService, Entity, FormService, Group, GroupService, inquiryType, Institution, InstitutionService, StepBase, WizardStorageService } from '../../shared';
