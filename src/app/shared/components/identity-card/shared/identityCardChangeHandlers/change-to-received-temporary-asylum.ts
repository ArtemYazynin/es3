...
export class ChangeToReceivedTemporaryAsylum extends IdentityCardChangeTemplate{
    ...
    setValidationMessages() {
        ...
        this.validationMessages["number"].pattern = this.validationMessage.requiredNumberOfDigits(2);
    }
